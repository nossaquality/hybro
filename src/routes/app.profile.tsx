...
            Vincule sua conta Google ou Apple para entrar mais facilmente.
          </p>
          {/* Google Button */}
          <button
...
            className="flex w-full items-center gap-3 rounded-xl border border-gray-900 bg-gray-900 px-4 py-3 text-sm font-medium text-white shadow-sm transition-all hover:bg-gray-800 dark:border-border"
          >
            <AppleIcon />
